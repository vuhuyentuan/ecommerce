    ...
    <div class="container">
        <div class="row">
                ...
                <div class="docs-sidebar">
                    <li class="docs_category">
                        ...
                        <ul>
                            ...
                            <li class="cat-item cat-item-132 current-cat"><a href="{{route('quote.document_detail.others')}}">@lang('doc.Others')</a></li>
                        </ul>
                    </li>
                </div>
            </div>
            <div class="col-md-8 col-md-offset-1">
                <div class="docs-list">
                    <h2>@lang('doc.Others')</h2>
                    <ul>
                        @foreach(explode('.', trans('doc.Others_content1')) as $line)
