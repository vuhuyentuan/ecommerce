    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="docs-sidebar">
                    <li class="docs_category">
                        ...
                        <ul>
                            <li class="cat-item cat-item-105"><a aria-current="page" href="{{route('quote.document_detail.setup_and_configuration')}}">@lang('doc.Setup&Configuration')</a></li>
                            <li class="cat-item cat-item-109 current-cat"><a href="{{route('quote.document_detail.manage_shop')}}">@lang('doc.Manage_Shop')</a></li>
            ...
            <div class="col-md-8 col-md-offset-1">
                <div class="docs-list">
                    <h2>@lang('doc.Manage_Shop')</h2>
                    <p>@lang('doc.Manage_Shop_content1')</p>
                    <ul>
                        @foreach(explode('.', trans('doc.Manage_Shop_content2')) as $line)
