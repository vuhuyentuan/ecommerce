...
Route::group(['prefix' => 'quote'], function(){
    Route::get('/overview', function(){
        return view('frontend.quote.overview');
    })->name('quote.overview');
    Route::get('/features', function(){
        return view('frontend.quote.features');
    })->name('quote.features');
    Route::get('/pricing', function(){
        return view('frontend.quote.pricing');
    })->name('quote.pricing');
    Route::get('/document', function(){
        return view('frontend.quote.doc');
    })->name('quote.doc');
    Route::get('/document/others', function(){
        return view('frontend.quote.document-detail.others');
    })->name('quote.document_detail.others');
    Route::get('/document/manage_shop', function(){
        return view('frontend.quote.document-detail.manage_shop');
    })->name('quote.document_detail.manage_shop');
    Route::get('/document/setup_and_configuration', function(){
        return view('frontend.quote.document-detail.setup_and_configuration');
    })->name('quote.document_detail.setup_and_configuration');

     Route::get('/footer-detail/products_support_policy', function(){
        return view('frontend.quote.footer-detail.products_support_policy');
    })->name('quote.footer-detail.products_support_policy');
     Route::get('/footer-detail/customization_terms_policy', function(){
        return view('frontend.quote.footer-detail.customization_terms_policy');
    })->name('quote.footer-detail.customization_terms_policy');


    Route::group(['prefix'=>'add-on'],function(){
        Route::get('/halovi-ecommerce-pos-manager',function(){
            return view('frontend.quote.addon.active_ecommerce_pos_manager');
        })->name('addon.active_ecommerce_pos_manager');
        Route::get('/halovi-ecommerce-club-point', function(){
            return view('frontend.quote.addon.club_point');
        })->name('addon.club_point');
        Route::get('/halovi-ecommerce-affiliate-system',function(){
            return view('frontend.quote.addon.ecommerce_affiliate_system');
        })->name('addon.affiliate_system');
        Route::get('/halovi-ecommerce-cms-system',function(){
            return view('frontend.quote.addon.ecommerce_cms_system');
        })->name('addon.cms_system');
         Route::get('/halovi-ecommerce-OTP-system',function(){
            return view('frontend.quote.addon.ecommerce_otp_system');
        })->name('addon.otp_system');
        Route::get('/halovi-ecommerce-offline-payment', function(){
            return view('frontend.quote.addon.offline_payment');
        })->name('addon.offline_payment');
        Route::get('/halovi-ecommerce-seller-subscription', function(){
            return view('frontend.quote.addon.seller_subscription');
        })->name('addon.seller_subscription');
        Route::get('/halovi-ecommerce-paytm-payment',function(){
            return view('frontend.quote.addon.active_ecommerce_paytm_payment');
        })->name('addon.active_ecommerce_paytm_payment');
        Route::get('/halovi-ecommerce-african-payment',function(){
            return view('frontend.quote.addon.active_ecommerce_african_payment');
        })->name('addon.active_ecommerce_african_payment');
    });
});