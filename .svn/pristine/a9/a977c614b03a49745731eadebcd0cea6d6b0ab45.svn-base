...
@section('content')
    <main class="content" id="content">
        <section
            data-row-bg="{{ static_asset('assets/img/african-payment-gateway-website-landing-page.jpg') }}"
            ...
            <div class="ld-container container">
                <div class="row ld-row">
                    <div
                        class="wpb_column vc_column_container vc_col-sm-10 vc_col-sm-offset-1 text-center liquid-column-60a218a78e30c">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper vc_custom_1527245307587">
                                <div class="wpb_wrapper-inner">
                                    <div
                                        class="wpb_single_image wpb_content_element vc_align_center  vc_custom_1612873656718 liquid_vc_single_image-60a218a8189b6">
                                        <figure class="wpb_wrapper vc_figure">
                                            <div class="vc_single_image-wrapper   vc_box_border_grey"><img style="max-width: 150px; height: auto;"
                                                    ...
                                                    data-src="{{ static_asset('assets/img/african-logo.png') }}"
                                                    data-srcset="{{ static_asset('assets/img/african-logo.png') }} 200w, {{ static_asset('assets/img/african-logo.png') }} 150w"
                                                    data-aspect="1" /></div>
                                        </figure>
                                    </div>
                                    <div class="ld-fancy-heading ld_fancy_heading_60a218a818a6c">
                                        <h1 class="lqd-highlight-underline lqd-highlight-grow-left" data-fittext="true"
                                            ...
                                            data-split-options='{"type":"words"}'><span class="ld-fh-txt">
                                                <strong><span
                                                        style="color: #ff6600">@lang('african_payment.active_ecommerce_african_payment_add_on')</span></strong></span>
                                        </h1>
                                    </div>
                                    <div class="ld-empty-space ld_spacer_60a218a818c65"><span
                                            ...
                                            <div class="ld-fancy-heading ld_fancy_heading_60a218778382c">
                                                <p class="lqd-highlight-underline lqd-highlight-grow-left" data-fittext="true"
                                                    ...
                                                    data-split-options='{"type":"lines"}'><span
                                                        class="ld-fh-txt">@lang('african_payment.bundle')</span>
                                                </p>
                                            </div>
                                                ...
                                                <div class="wpb_wrapper ">
                                                    <div class="wpb_wrapper-inner"><a href="#" target="_blank"
                                                            ...
                                                            <span> <span style="padding-right: 18px; padding-left: 18px"
                                                                    class="btn-txt">@lang('african_payment.check_demo')</span>
                                                            </span>
                                                        </a></div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="wpb_wrapper ">
                                                    <div class="wpb_wrapper-inner"><a href="#pricing"
                                                            ...
                                                            data-localscroll="true"> <span> <span
                                                                    class="btn-txt">@lang('african_payment.check_pricing')</span>
                                                            </span>
                                                        </a></div>
                                                </div>
                                            </div>
        ...
        <section data-custom-animations="true"
            ...
            data-bg-image="url"
            class="vc_row wpb_row vc_row-fluid all-features-icon vc_custom_1582620489012 row-contains-padding-top row-contains-padding-bottom liquid-row-shadowbox-60a218a81b83c vc_row-has-fill vc_row-has-bg vc_column-gap-10 vc_row-o-equal-height vc_row-flex">
            <div class="ld-container container">
                <div class="row ld-row">
                    <div class="wpb_column vc_column_container vc_col-sm-12 liquid-column-60a218a81bb8e">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper vc_custom_1582584173891">
                                <div class="wpb_wrapper-inner">
                                    <div class="ld-fancy-heading ld_fancy_heading_60a218a81bc9d">
                                        <h4 class="lqd-highlight-underline lqd-highlight-grow-left">
                                            <span class="ld-fh-txt">
                                                @lang('african_payment.african_payment_gateway_system')
                                            </span>
                                        </h4>
                                    </div>
                                </div>
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-4 vc_col-md-4 vc_col-xs-6 text-center liquid-column-60a218a81c057">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper ">
                                <div class="wpb_wrapper-inner">
                                    <div class="iconbox iconbox-round iconbox-shadow iconbox-circle iconbox-sm iconbox-heading-xs iconbox-filled ld_icon_box_60a218a81c169"
                                        id="ld_icon_box_60a218a81c169" data-plugin-options='{"color":"rgb(50, 99, 51)"}'>
                                        <div class="iconbox-icon-wrap"><span class="iconbox-icon-container" style="color: #326333;background: #9abf9b;"><i
                                                    class="fas fa-cogs"></i></span></div>
                                        <!-- /.iconbox-icon-wrap -->
                                        <h3 class="font-weight-normal">@lang('african_payment.config_page_easily')</h3>
                                    </div>
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-4 vc_col-md-4 vc_col-xs-6 liquid-column-60a218a81c59a">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper ">
                                <div class="wpb_wrapper-inner">
                                    <div class="iconbox iconbox-round iconbox-shadow iconbox-circle iconbox-sm iconbox-heading-xs iconbox-filled ld_icon_box_60a218a81c6bf"
                                        id="ld_icon_box_60a218a81c6bf" data-plugin-options='{"color":"rgb(50, 99, 51)"}'>
                                        <div class="iconbox-icon-wrap"><span class="iconbox-icon-container" style="color: #326333;background: #9abf9b;"><i
                                                    class="fas fa-check-square"></i></span></div>
                                        <!-- /.iconbox-icon-wrap -->
                                        <h3 class="font-weight-normal">
                                            @lang('african_payment.african_payment_gateway_in_checkout')</h3>
                                    </div>
                                    <div class="vc_empty_space" style="height: 30px"><span
                                            class="vc_empty_space_inner"></span></div>
                                </div>
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-4 vc_col-md-4 vc_col-xs-6 liquid-column-60a218a81cadb">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper ">
                                <div class="wpb_wrapper-inner">
                                    <div class="iconbox iconbox-round iconbox-shadow iconbox-circle iconbox-sm iconbox-heading-xs iconbox-filled ld_icon_box_60a218a81cbe0"
                                        id="ld_icon_box_60a218a81cbe0" data-plugin-options='{"color":"rgb(50, 99, 51)"}'>
                                        <div class="iconbox-icon-wrap"><span class="iconbox-icon-container" style="color: #326333;background: #9abf9b;"><i
                                                    class="icon-md-wallet"></i></span></div>
                                        <!-- /.iconbox-icon-wrap -->
                                        <h3 class="font-weight-normal">
                                            @lang('african_payment.african_payment_in_wallet_recharge')</h3>
                                    </div>
                                    <div class="vc_empty_space" style="height: 30px"><span
                                            class="vc_empty_space_inner"></span></div>
                                </div>
        ...
        <section
            class="vc_row wpb_row vc_row-fluid vc_custom_1587032513478 row-contains-padding-top row-contains-padding-bottom liquid-row-shadowbox-60a218a81cfee">
            <div class="ld-container container">
                <div class="row ld-row">
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-offset-3 vc_col-md-6 text-center liquid-column-60a218a81d382">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper " data-custom-animations="true"
                                ...
                                <div class="wpb_wrapper-inner">
                                    <div class="ld-fancy-heading ld_fancy_heading_60a218a81d442">
                                        <h2 class="lqd-highlight-underline lqd-highlight-grow-left"><span class="ld-fh-txt">
                                                @lang('african_payment.how_it_works')</span></h2>
                                    </div>
                                    <div class="ld-empty-space ld_spacer_60a218a81d515"><span
                                            class="liquid_empty_space_inner"></span></div>
                                </div>
                            </div>
                        </div>
        ...
        <section data-bg-image="url"
            class="vc_row wpb_row vc_row-fluid vc_custom_1587346659554 row-contains-padding-top row-contains-padding-bottom liquid-row-shadowbox-60a218a81d81d vc_row-has-fill vc_row-has-bg vc_row-o-content-middle vc_row-flex">
            <div class="ld-container container">
                <div class="row ld-row">
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-offset-0 vc_col-md-6 text-center liquid-column-60a218a81db4b">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper ">
                                <div class="wpb_wrapper-inner">
                                    <div id="ld_images_group_container_60a218a81dbf6"
                                        class="liquid-img-group-container ld_images_group_container_60a218a81dbf6">
                                        <div class="liquid-img-group-inner">
                                            <div id="ld_images_group_element_60a218a81dd40"
                                                class="liquid-img-group-single ld_images_group_element_60a218a81dd40"
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6 liquid-column-60a218a8855c2 liquid-column-responsive-60a218a8855c5 vc_col-has-fill">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper vc_custom_1587360090457" data-custom-animations="true"
                                ...
                                <div class="wpb_wrapper-inner">
                                    <div class="ld-fancy-heading ld_fancy_heading_60a218a8857d0">
                                        <h4 class="lqd-highlight-underline lqd-highlight-fadein">
                                            <span class="ld-fh-txt">
                                                <strong>
                                                    @lang('african_payment.african_payment_gateway')
                                                </strong>
                                            </span>
                                        </h4>
                                    </div>
                                    <div class="ld-empty-space ld_spacer_60a218a885a15"><span
                                            class="liquid_empty_space_inner"></span></div>
                                </div>
                            </div>
                        </div>
        ...
        <section data-bg-image="url"
            class="vc_row wpb_row vc_row-fluid vc_custom_1582582297559 row-contains-padding-top row-contains-padding-bottom liquid-row-shadowbox-60a218a885ee7 vc_row-has-fill vc_row-has-bg vc_row-o-content-middle vc_row-flex">
            <div class="ld-container container">
                <div class="row ld-row">
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6 liquid-column-60a218a8863f0 liquid-column-responsive-60a218a8863f1">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper " data-custom-animations="true"
                                data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1600","delay":"160","easing":"easeOutQuint","direction":"forward","initValues":{"translateY":30,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
                                <div class="wpb_wrapper-inner">
                                    <div class="ld-fancy-heading ld_fancy_heading_60a218a886565">
                                        <h4 class="lqd-highlight-underline lqd-highlight-grow-left">
                                            <span class="ld-fh-txt">
                                                <strong>
                                                    @lang('african_payment.customers_will_get_payment')
                                                </strong>
                                            </span>
                                        </h4>
                                    </div>
                                    <div class="ld-empty-space ld_spacer_60a218a8867b5"><span
                                            class="liquid_empty_space_inner"></span></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-offset-0 vc_col-md-6 text-center liquid-column-60a218a886c74">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper ">
                                <div class="wpb_wrapper-inner">
                                    <div id="ld_images_group_container_60a218a886db6"
                                        class="liquid-img-group-container ld_images_group_container_60a218a886db6">
                                        <div class="liquid-img-group-inner">
                                            <div id="ld_images_group_element_60a218a886fcf"
                                                class="liquid-img-group-single ld_images_group_element_60a218a886fcf"
                                                data-shadow-style="4" data-roundness="4" data-inview="true"
                                                data-animate-shadow="true">
                                                <div class="liquid-img-group-img-container">
                                                    <div class="liquid-img-container-inner">
        ...
        <section data-bg-image="url"
            class="vc_row wpb_row vc_row-fluid vc_custom_1582578619813 row-contains-padding-top row-contains-padding-bottom liquid-row-shadowbox-60a218a9008ea vc_row-has-fill vc_row-has-bg vc_row-o-content-middle vc_row-flex">
            <div class="ld-container container">
                <div class="row ld-row">
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-offset-0 vc_col-md-6 text-center liquid-column-60a218a900c47">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper ">
                                <div class="wpb_wrapper-inner">
                                    <div id="ld_images_group_container_60a218a900d21"
                                        class="liquid-img-group-container ld_images_group_container_60a218a900d21">
                                        <div class="liquid-img-group-inner">
                                            <div id="ld_images_group_element_60a218a900e89"
                                                class="liquid-img-group-single ld_images_group_element_60a218a900e89"
                                                data-shadow-style="4" data-roundness="4" data-inview="true"
                                                data-animate-shadow="true">
                                                <div class="liquid-img-group-img-container">
                                                    <div class="liquid-img-container-inner">
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6 liquid-column-60a218a9bdb9f liquid-column-responsive-60a218a9bdba1">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper " data-custom-animations="true"
                                data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1600","delay":"160","easing":"easeOutQuint","direction":"forward","initValues":{"translateY":30,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
                                <div class="wpb_wrapper-inner">
                                    <div class="ld-fancy-heading ld_fancy_heading_60a218a9bdcba">
                                        <h4 class="lqd-highlight-underline lqd-highlight-grow-left">
                                            <span class="ld-fh-txt">
                                                <strong>
                                                    @lang('african_payment.customers_will_get_african_payment_gateway')
                                                </strong>
                                            </span>
                                        </h4>
                                    </div>
                                    <div class="ld-empty-space ld_spacer_60a218a9bde4c"><span
                                            class="liquid_empty_space_inner"></span></div>
                                </div>
                            </div>
                        </div>
