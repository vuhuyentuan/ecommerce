...
class DeliveryBoyController extends Controller
{
    ...
    public function dashboard_summary($id)
    {
        ...
        return response()->json([
            ...
            'pending_delivery' => Order::where('assign_delivery_boy', $id)->where('delivery_status', '!=', 'delivered')->where('delivery_status', '!=', 'cancelled')->count(),
            ...
            'on_the_way' => Order::where('assign_delivery_boy', $id)->where('delivery_status', 'on_the_way')->count(),
            'picked' => Order::where('assign_delivery_boy', $id)->where('delivery_status', 'picked_up')->count(),
            'assigned' => Order::where('assign_delivery_boy', $id)->where('delivery_status', 'assigned')->count(),
